...
import { getAllAddressUserByUserIdService, 
...
function AddressUser(props) {
    ...
    return (
        ...
        <div className="container rounded bg-white mt-5 mb-5">
            ...
            <AddressUsersModal addressUserId={addressUserId} sendDataFromModalAddress={sendDataFromModalAddress}
             isOpenModal={isOpenModalAddressUser} closeModaAddressUser={closeModaAddressUser} />
        </div>
    );
}
